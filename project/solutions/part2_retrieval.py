...
Each function is rebound by ``solutions`` onto the real project code:
    ...
    hybrid_search            -> RetrievalCore.hybrid_search
...
@todo
def hybrid_search(self, query: str, top_k=None, metadata_filter=None, overretrieve=None):
    """Over-retrieve from both branches, then fuse. Implemented in Part 2.4 of the notebook."""
    raise NotImplementedError("Implement hybrid_search in the notebook and export it here.")


@todo
def retrieve_and_answer(self, query: str, search_type=None, metadata_filter=None):
    """Retrieve, stuff context, ask the LLM; return (answer, sources). Implemented in Part 2.6."""
