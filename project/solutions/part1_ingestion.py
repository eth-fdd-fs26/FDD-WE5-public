...
Each function is rebound by ``solutions`` onto the real project code:
    ...
    apply_metadata_filter  -> RetrievalCore._apply_metadata_filter
...
@todo
def apply_metadata_filter(chunks, metadata_filter):  # noqa: ANN001 - bound as a staticmethod
    """Keep only chunks matching every key/value in the filter. Implemented in Part 1.3."""
    raise NotImplementedError("Implement apply_metadata_filter in the notebook and export it here.")
